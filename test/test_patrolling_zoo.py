...
class TestEnvironment(unittest.TestCase):
    ...
    def test_state(self):
        ...
        state = env.state()
        self.assertEqual(state["vertex_state"][0], 0.0)
        self.assertEqual(state["vertex_state"][1], 0.0)
        self.assertEqual(state["vertex_state"][2], 0.0)
        self.assertEqual(state["vertex_state"][3], 0.0)
        self.assertEqual(state["vertex_distances"][agent][0], 45.0)
        self.assertEqual(state["vertex_distances"][agent][1], 5.0)
        self.assertEqual(state["vertex_distances"][agent][2], 60.0)
        self.assertEqual(state["vertex_distances"][agent][3], 20.0)
