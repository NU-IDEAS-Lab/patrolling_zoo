...
all_args.experiment_name = "6SharedAttritionYesCommsNoSkipSyncGNN"
...
all_args.attrition_method = "random"
all_args.attrition_random_probability = 1.0 / 1000.0
...
all_args.hidden_size = 700

all_args.save_interval = 100
all_args.n_rollout_threads = 3
all_args.cuda = True
all_args.cuda_idx = 7
